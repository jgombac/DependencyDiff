...
<br>
<span class="message-data-name user-2">
  <div class="typings"><i class="fa fa-circle online"></i> Typing
    <span class="loader-dot">.</span>
    <span class="loader-dot">.</span>
    <span class="loader-dot">.</span>
  </div>
    ...
    <div class="people-list" id="people-list">
      <div class="media">
        <a class="pull-left" href="#">
          <img class="media-object dp img-circle" src="{{'https://hitesh-batcave.herokuapp.com/' + user.avatar}}" style="width: 70px; height:70px;">
        </a>
      ...
      <ul class="list" *ngIf="!isSearchDraft">
        <li class="clearfix" *ngFor="let row of users">
          <img src="{{'https://hitesh-batcave.herokuapp.com/' + row.avatar}}" class="img-circle" alt="avatar" />
  ...
  <div id="page-content-wrapper">
    <div class="chat" *ngIf="currentThread">
      <div class="chat-header clearfix">
        <img src="{{'https://hitesh-batcave.herokuapp.com/' + currentThread.avatar}}" class="img-circle" alt="avatar" />
